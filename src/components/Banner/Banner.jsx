        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-10 items-center">
          ...
          <div className="flex flex-col justify-center gap-6">
            ...
            <div data-aos="fade-up" data-aos-delay="400">
              <button className="mt-6 inline-block bg-gradient-to-r from-primary to-secondary text-white font-medium py-3 px-6 rounded-full hover:scale-105 transition-transform duration-300">
                Shop Now
              </button>
            </div>
